...
public class Display extends Canvas implements Runnable {
	...
	public void run() {
		...
		while (running) {
			...
			requestFocus();//////自動切入遊戲（不須點擊畫面才可操控）
	...
	private void render() {
		...
		g.drawImage(img, 0, 0, WIDTH, HEIGHT, null); /// 如果畫面邊框閃爍調整width ,height+常數
		g.setFont(new Font("Verdana",0,50)); //type,style(0:normal/1:bold/2:斜線/3:both),size
	...
	public static void main(String[] args) {
		...
		frame.setResizable(true); /////// 是否可以調整視窗大小
